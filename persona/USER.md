...
§
Chinese-speaking user (QQ platform). Prefers deepseek-v4-pro over deepseek-v4-flash for better quality. Writes Chinese web novels but can change direction suddenly. Likes subtle foreshadowing and character depth.
§
